...
<div id="footer">
    ...
    <tr>
      <td align="center"><b><a href="signup.php">SIGN UP</a></b></td>
    </tr>
  </table>
</div>
<!-- InstanceEndEditable -->
...
<div id="form">
  <form id="form1" name="form1" method="post" action="php/login.php" onsubmit="return validateForm()">
  <table id="login" width="25%"  align="center" cellspacing="15" cellpadding="10">
  <tr id="tableHead">
      <th colspan="2" width="100%" align="center"><strong>LOGIN FORM:</strong></th>
